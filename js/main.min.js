...
/* harmony import */ var _modules_init_change_text__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-change-text */ "./js/modules/init-change-text.js");
...
Object(_modules_init_change_text__WEBPACK_IMPORTED_MODULE_2__["initChangeText"])();
...
/*!****************************************!*\
  !*** ./js/modules/init-change-text.js ***!
  \****************************************/
/*! exports provided: initChangeText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initChangeText", function() { return initChangeText; });
var initChangeText = function initChangeText() {
  var texts = document.querySelectorAll('.js-text-changer');

  if (!texts.length) {
    return;
  }

  var breakpointSm = window.matchMedia('(max-width: 699px)');
  var breakpointMd = window.matchMedia('(max-width: 849px)');
